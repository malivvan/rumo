...
- `date(year int, month int, day int, hour int, min int, sec int, nsec int) => time`: returns a time in UTC corresponding to the given date and time
- `date_in(zone string, year int, month int, day int, hour int, min int, sec int, nsec int) => time`: returns a time in the given timezone corresponding to the given date and time
