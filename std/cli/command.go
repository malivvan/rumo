...
// In addition to providing an interface, Cli simultaneously provides a controller to organize your application code.
package cli
...
const (
	FlagSetByCliAnnotation       = "cli_annotation_flag_set_by_cli"
	CommandDisplayNameAnnotation = "cli_annotation_command_display_name"
...
// E.g.  'go run ...' - 'run' is the command. Cli requires
...
type Command struct {
	...
	// DisableAutoGenTag defines, if gen tag ("Auto generated by spf13/cli...")
...
func (c *Command) HelpFunc() func(*Command, []string) {
	...
	return func(c *Command, a []string) {
		...
		// See https://github.com/malivvan/rumo/std/cli/issues/1002
...
func (c *Command) InitDefaultHelpFlag() {
	...
	if c.Flags().Lookup(helpFlagName) == nil {
		...
		_ = c.Flags().SetAnnotation(helpFlagName, FlagSetByCliAnnotation, []string{"true"})
	}
}
...
func (c *Command) InitDefaultVersionFlag() {
	...
	if c.Flags().Lookup("version") == nil {
		...
		_ = c.Flags().SetAnnotation("version", FlagSetByCliAnnotation, []string{"true"})
	}
}
...
// Concrete example: https://github.com/malivvan/rumo/std/cli/issues/393#issuecomment-282741924.
