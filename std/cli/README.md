...
[![Run Tests](https://github.com/malivvan/rumo/std/cli/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/malivvan/rumo/std/cli/actions/workflows/tests.yml)
[![Go Reference](https://pkg.go.dev/badge/github.com/malivvan/rumo/std/cli.svg)](https://pkg.go.dev/github.com/malivvan/rumo/std/cli)
[![Go Report Card](https://goreportcard.com/badge/github.com/malivvan/rumo/std/cli)](https://goreportcard.com/report/github.com/malivvan/rumo/std/cli)
...
```sh
go get github.com/malivvan/rumo/std/cli
```
