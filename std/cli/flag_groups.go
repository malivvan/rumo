...
const (
	requiredAsGroupAnnotation   = "cli_annotation_required_if_others_set"
	oneRequiredAnnotation       = "cli_annotation_one_required"
	mutuallyExclusiveAnnotation = "cli_annotation_mutually_exclusive"
)

// MarkFlagsRequiredTogether marks the given flags with annotations so that Cli errors
...
// MarkFlagsOneRequired marks the given flags with annotations so that Cli errors
...
// MarkFlagsMutuallyExclusive marks the given flags with annotations so that Cli errors
