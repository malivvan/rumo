...
func TestFlagCompletionWorksRootCommandAddedAfterFlags(t *testing.T) {
	...
	// Important: This is a test for https://github.com/malivvan/rumo/std/cli/issues/1437
...
// https://github.com/malivvan/rumo/std/cli/issues/1320
//
...
func TestCompleteWithDisableFlagParsing(t *testing.T) {
	...
	// after Cli tried to complete the flags it knows about.
	...
	// Test that when DisableFlagParsing==false, Cli completes the flags itself and ValidArgsFunction is not called
	...
	// Cli was not told of any flags, so it returns nothing
	expected = strings.Join([]string{
		"--persistent",
		"-p",
		"--help",
...
func TestCompletionCliFlags(t *testing.T) {
	getCmd := func() *Command {
		rootCmd := &Command{
			Use:     "root",
			Version: "1.1.1",
...
func TestArgsNotDetectedAsFlagsCompletionInGo(t *testing.T) {
	...
	// https://github.com/malivvan/rumo/std/cli/issues/1816 does not occur anymore.
