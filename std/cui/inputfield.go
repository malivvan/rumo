...
func NewInputField() *InputField {
	return &InputField{
		...
		autocompleteListTextColor:               Styles.WidgetBackgroundColor,
		autocompleteListBackgroundColor:         Styles.MoreContrastBackgroundColor,
		autocompleteListSelectedTextColor:       Styles.WidgetBackgroundColor,
...
func (i *InputField) InputHandler() func(event *tcell.EventKey, setFocus func(w Widget)) {
	return i.WrapInputHandler(func(event *tcell.EventKey, setFocus func(w Widget)) {
		i.Lock()
...
func (i *InputField) MouseHandler() func(action MouseAction, event *tcell.EventMouse, setFocus func(w Widget)) (consumed bool, capture Widget) {
	return i.WrapMouseHandler(func(action MouseAction, event *tcell.EventMouse, setFocus func(w Widget)) (consumed bool, capture Widget) {
		x, y := event.Position()
