...
The presentation will advance to the next slide when the widget demonstrated
...
// information and its main widget, its. It receives a "nextSlide" function
...
func main() {
	...
	for index, slide := range slides {
		...
		title, info, widget := slide(nextSlide)
