...
func main() {
	...
	iowaitSparkline.SetBorderColor(color.DimGray)
	iowaitSparkline.SetTitleColor(color.DimGray)
	iowaitSparkline.SetDataTitleColor(color.DarkOrange)
	iowaitSparkline.SetLineColor(color.MediumPurple)

	systemSparkline := cui.NewSparkline()
	systemSparkline.SetBorder(false)
	systemSparkline.SetDataTitle("Disk I/O (system)")
	systemSparkline.SetBorderColor(color.DimGray)
	systemSparkline.SetTitleColor(color.DimGray)
	systemSparkline.SetDataTitleColor(color.DarkOrange)
	systemSparkline.SetLineColor(color.SteelBlue)
	...
	sparklineGroupLayout.SetBorderColor(color.DimGray)
	sparklineGroupLayout.SetTitle("DISK IO")
	sparklineGroupLayout.SetTitleColor(color.DarkOrange)
