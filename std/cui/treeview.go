...
type TreeView struct {
	*Box
	...
	// An optional function called when the user moves away from this widget.
...
func (t *TreeView) Draw(screen tcell.Screen) {
	...
	// Draw the tree.
	posY := y
	lineStyle := tcell.StyleDefault.Background(backgroundColor).Foreground(t.graphicsColor)
	for index, node := range t.nodes {
