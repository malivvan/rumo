...
ColumnLoop:
	...
	tableBackgroundColor := t.GetBackgroundColor()

	// Helper function which draws border runes.
	borderStyle := tcell.StyleDefault.Background(tableBackgroundColor).Foreground(t.bordersColor)
	...
	// invert == true => Ignore attr, set text to backgroundColor or the table background;
