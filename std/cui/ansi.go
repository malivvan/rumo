...
// ansi is a io.Writer which translates ANSI escape codes into cui color
// tags.
type ansi struct {
	io.Writer
...
// written to it into cui color tags. Other escape codes don't have an effect
...
// with cui's color tags and returns the resulting string.
