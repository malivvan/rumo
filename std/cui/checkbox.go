...
func (c *CheckBox) InputHandler() func(event *tcell.EventKey, setFocus func(w Widget)) {
	return c.WrapInputHandler(func(event *tcell.EventKey, setFocus func(w Widget)) {
...
func (c *CheckBox) MouseHandler() func(action MouseAction, event *tcell.EventMouse, setFocus func(w Widget)) (consumed bool, capture Widget) {
	return c.WrapMouseHandler(func(action MouseAction, event *tcell.EventMouse, setFocus func(w Widget)) (consumed bool, capture Widget) {
		x, y := event.Position()
