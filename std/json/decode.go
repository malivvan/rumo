...
func (d *decodeState) array() (vm.Object, error) {
	var arr []vm.Object
	for {
	...
	return &vm.Array{Value: arr}, nil
}

func (d *decodeState) object() (vm.Object, error) {
	...
	return &vm.Map{Value: m}, nil
}

func (d *decodeState) literal() (vm.Object, error) {
