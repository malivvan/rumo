...
import (
	...
	"github.com/malivvan/rumo/std/shell/ansi"
...
1. ioLoop() runs asynchronously. It operates in lockstep with the read methods:
   ...
   outChan. It does block reads from stdin, reading as little as possible at
...
// GetCursorPosition sends a DSR query to get the current offset, then blocks until the query returns.
