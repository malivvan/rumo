...
import (
	...
	"github.com/malivvan/rumo/vm/purego/internal/xreflect"
)
...
// only invoking [github.com/malivvan/rumo/vm/purego.NewCallback] when it encounters a new function type (rather than on for every block creation).
