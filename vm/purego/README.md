# purego
[![Go Reference](https://pkg.go.dev/badge/github.com/malivvan/rumo/vm/purego?GOOS=darwin.svg)](https://pkg.go.dev/github.com/malivvan/rumo/vm/purego?GOOS=darwin)
...
2. These architectures require the special flag `-gcflags="github.com/malivvan/rumo/vm/purego/internal/fakecgo=-std"` to compile with CGO_ENABLED=0
...
be seen in the complete example at [examples/libc](https://github.com/malivvan/rumo/vm/purego/tree/main/examples/libc) which supports FreeBSD and Windows.
