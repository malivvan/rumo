...
func TestFuncARI(t *testing.T) {
	uf := module.Func(func() int { return 10 })
	ret, err := funcCall(uf)
	require.NoError(t, err)
...
func TestFuncARE(t *testing.T) {
	uf := module.Func(func() error { return nil })
	ret, err := funcCall(uf)
	require.NoError(t, err)
	require.Equal(t, vm.TrueValue, ret)
	uf = module.Func(func() error { return errors.New("some error") })
	ret, err = funcCall(uf)
	require.NoError(t, err)
...
func TestFuncARS(t *testing.T) {
	uf := module.Func(func() string { return "foo" })
	ret, err := funcCall(uf)
	require.NoError(t, err)
...
func TestFuncARSE(t *testing.T) {
	uf := module.Func(func() (string, error) { return "foo", nil })
	ret, err := funcCall(uf)
	require.NoError(t, err)
	require.Equal(t, &vm.String{Value: "foo"}, ret)
	uf = module.Func(func() (string, error) {
...
func TestFuncARSs(t *testing.T) {
	uf := module.Func(func() []string { return []string{"foo", "bar"} })
	ret, err := funcCall(uf)
	require.NoError(t, err)
...
func TestFuncASRE(t *testing.T) {
	uf := module.Func(func(a string) error { return nil })
	ret, err := funcCall(uf, &vm.String{Value: "foo"})
	require.NoError(t, err)
	require.Equal(t, vm.TrueValue, ret)
	uf = module.Func(func(a string) error {
		return errors.New("some error")
	})
	ret, err = funcCall(uf, &vm.String{Value: "foo"})
	require.NoError(t, err)
...
func TestFuncASRS(t *testing.T) {
	uf := module.Func(func(a string) string { return a })
	ret, err := funcCall(uf, &vm.String{Value: "foo"})
	require.NoError(t, err)
	require.Equal(t, &vm.String{Value: "foo"}, ret)
	_, err = funcCall(uf)
...
func TestFuncASRSs(t *testing.T) {
	uf := module.Func(func(a string) []string { return []string{a} })
	ret, err := funcCall(uf, &vm.String{Value: "foo"})
	require.NoError(t, err)
...
func TestFuncASI64RE(t *testing.T) {
	uf := module.Func(func(a string, b int64) error { return nil })
	ret, err := funcCall(uf, &vm.String{Value: "foo"}, &vm.Int{Value: 5})
	require.NoError(t, err)
	require.Equal(t, vm.TrueValue, ret)
	uf = module.Func(func(a string, b int64) error {
		return errors.New("some error")
	})
	ret, err = funcCall(uf, &vm.String{Value: "foo"}, &vm.Int{Value: 5})
	require.NoError(t, err)
...
func TestFuncAIIRE(t *testing.T) {
	uf := module.Func(func(a, b int) error { return nil })
	ret, err := funcCall(uf, &vm.Int{Value: 5}, &vm.Int{Value: 7})
	require.NoError(t, err)
	require.Equal(t, vm.TrueValue, ret)
	uf = module.Func(func(a, b int) error {
		return errors.New("some error")
	})
	ret, err = funcCall(uf, &vm.Int{Value: 5}, &vm.Int{Value: 7})
	require.NoError(t, err)
...
func TestFuncASIIRE(t *testing.T) {
	uf := module.Func(func(a string, b, c int) error { return nil })
	ret, err := funcCall(uf, &vm.String{Value: "foo"}, &vm.Int{Value: 5},
		&vm.Int{Value: 7})
	require.NoError(t, err)
	require.Equal(t, vm.TrueValue, ret)
	uf = module.Func(func(a string, b, c int) error {
		return errors.New("some error")
	})
	ret, err = funcCall(uf, &vm.String{Value: "foo"}, &vm.Int{Value: 5},
		&vm.Int{Value: 7})
...
func TestFuncASRSE(t *testing.T) {
	uf := module.Func(func(a string) (string, error) { return a, nil })
	ret, err := funcCall(uf, &vm.String{Value: "foo"})
	require.NoError(t, err)
	require.Equal(t, &vm.String{Value: "foo"}, ret)
	uf = module.Func(func(a string) (string, error) {
...
func TestFuncASSRE(t *testing.T) {
	uf := module.Func(func(a, b string) error { return nil })
	ret, err := funcCall(uf, &vm.String{Value: "foo"},
		&vm.String{Value: "bar"})
	require.NoError(t, err)
	require.Equal(t, vm.TrueValue, ret)
	uf = module.Func(func(a, b string) error {
		return errors.New("some error")
	})
	ret, err = funcCall(uf, &vm.String{Value: "foo"},
		&vm.String{Value: "bar"})
...
func TestFuncASsRS(t *testing.T) {
	uf := module.Func(func(a []string, b string) string {
...
func TestFuncARF(t *testing.T) {
	uf := module.Func(func() float64 { return 10.0 })
	ret, err := funcCall(uf)
	require.NoError(t, err)
...
func TestFuncAFRF(t *testing.T) {
	uf := module.Func(func(a float64) float64 { return a })
...
func TestFuncAIRF(t *testing.T) {
	uf := module.Func(func(a int) float64 {
		return float64(a)
	})
...
func TestFuncAFRI(t *testing.T) {
	uf := module.Func(func(a float64) int {
		return int(a)
	})
...
func TestFuncAFRB(t *testing.T) {
	uf := module.Func(func(a float64) bool {
		return a > 0.0
	})
...
func TestFuncAFFRF(t *testing.T) {
	uf := module.Func(func(a, b float64) float64 {
		return a + b
	})
	ret, err := funcCall(uf, &vm.Float{Value: 10.0},
		&vm.Float{Value: 20.0})
...
func TestFuncASIRS(t *testing.T) {
	uf := module.Func(func(a string, b int) string {
...
func TestFuncAIFRF(t *testing.T) {
	uf := module.Func(func(a int, b float64) float64 {
		return float64(a) + b
	})
...
func TestFuncAFIRF(t *testing.T) {
	uf := module.Func(func(a float64, b int) float64 {
		return a + float64(b)
	})
...
func TestFuncAFIRB(t *testing.T) {
	uf := module.Func(func(a float64, b int) bool {
		return a < float64(b)
	})
	ret, err := funcCall(uf, &vm.Float{Value: 10.0}, &vm.Int{Value: 20})
	require.NoError(t, err)
...
func TestFuncAIRSsE(t *testing.T) {
	uf := module.Func(func(a int) ([]string, error) {
...
func TestFuncASSRSs(t *testing.T) {
	uf := module.Func(func(a, b string) []string {
		return []string{a, b}
	})
	ret, err := funcCall(uf, &vm.String{Value: "foo"},
		&vm.String{Value: "bar"})
...
func TestFuncASSIRSs(t *testing.T) {
	uf := module.Func(func(a, b string, c int) []string {
...
func TestFuncARB(t *testing.T) {
	uf := module.Func(func() bool { return true })
	ret, err := funcCall(uf)
	require.NoError(t, err)
	require.Equal(t, vm.TrueValue, ret)
	_, err = funcCall(uf, vm.TrueValue)
...
func TestFuncARYE(t *testing.T) {
	uf := module.Func(func() ([]byte, error) {
...
func TestFuncASRIE(t *testing.T) {
	uf := module.Func(func(a string) (int, error) { return 5, nil })
	ret, err := funcCall(uf, &vm.String{Value: "foo"})
	require.NoError(t, err)
	require.Equal(t, &vm.Int{Value: 5}, ret)
	uf = module.Func(func(a string) (int, error) {
...
func TestFuncAYRIE(t *testing.T) {
	uf := module.Func(func(a []byte) (int, error) { return 5, nil })
	ret, err := funcCall(uf, &vm.Bytes{Value: []byte("foo")})
	require.NoError(t, err)
	require.Equal(t, &vm.Int{Value: 5}, ret)
	uf = module.Func(func(a []byte) (int, error) {
		return 0, errors.New("some error")
	})
	ret, err = funcCall(uf, &vm.Bytes{Value: []byte("foo")})
	require.NoError(t, err)
...
func TestFuncASSRI(t *testing.T) {
	uf := module.Func(func(a, b string) int { return len(a) + len(b) })
	ret, err := funcCall(uf,
...
func TestFuncASSRS(t *testing.T) {
	uf := module.Func(func(a, b string) string { return a + b })
	ret, err := funcCall(uf,
		&vm.String{Value: "foo"}, &vm.String{Value: "bar"})
	require.NoError(t, err)
...
func TestFuncASSRB(t *testing.T) {
	uf := module.Func(func(a, b string) bool { return len(a) > len(b) })
	ret, err := funcCall(uf,
...
func TestFuncAIRS(t *testing.T) {
	uf := module.Func(func(a int) string { return strconv.Itoa(a) })
...
func TestFuncAIRIs(t *testing.T) {
	uf := module.Func(func(a int) []int { return []int{a, a} })
	ret, err := funcCall(uf, &vm.Int{Value: 55})
	require.NoError(t, err)
...
func TestFuncARI64(t *testing.T) {
	uf := module.Func(func() int64 { return 55 })
	ret, err := funcCall(uf)
	require.NoError(t, err)
...
func TestFuncAI64RI64(t *testing.T) {
	uf := module.Func(func(a int64) int64 { return a * 2 })
	ret, err := funcCall(uf, &vm.Int{Value: 55})
	require.NoError(t, err)
