...
func (o *testopts) Symbol(name string, value vm.Object) *testopts {
	c := o.copy()
...
func TestUndefined(t *testing.T) {
	expectRun(t, `out = undefined`, nil, vm.UndefinedValue)
	expectRun(t, `out = undefined.a`, nil, vm.UndefinedValue)
	expectRun(t, `out = undefined[1]`, nil, vm.UndefinedValue)
	expectRun(t, `out = undefined.a.b`, nil, vm.UndefinedValue)
	expectRun(t, `out = undefined[1][2]`, nil, vm.UndefinedValue)
...
func TestBuiltinFunction(t *testing.T) {
	...
	expectRun(t, `out = int([1])`, nil, vm.UndefinedValue)
	expectRun(t, `out = int({a: 1})`, nil, vm.UndefinedValue)
	expectRun(t, `out = int(undefined)`, nil, vm.UndefinedValue)
	...
	expectRun(t, `out = int(undefined, undefined)`, nil, vm.UndefinedValue)
	...
	expectRun(t, `out = string(undefined)`, nil, vm.UndefinedValue) // not "undefined"
	...
	expectRun(t, `out = float(true)`, nil, vm.UndefinedValue)
	expectRun(t, `out = float(false)`, nil, vm.UndefinedValue)
	expectRun(t, `out = float('8')`, nil, vm.UndefinedValue)
	expectRun(t, `out = float([1,8.1,true,3])`, nil, vm.UndefinedValue)
	expectRun(t, `out = float({a: 1, b: "foo"})`, nil, vm.UndefinedValue)
	expectRun(t, `out = float(undefined)`, nil, vm.UndefinedValue)
	...
	expectRun(t, `out = float(undefined, undefined)`, nil, vm.UndefinedValue)

	expectRun(t, `out = char(56)`, nil, '8')
	expectRun(t, `out = char(1.8)`, nil, vm.UndefinedValue)
	expectRun(t, `out = char("-52.2")`, nil, vm.UndefinedValue)
	expectRun(t, `out = char(true)`, nil, vm.UndefinedValue)
	expectRun(t, `out = char(false)`, nil, vm.UndefinedValue)
	expectRun(t, `out = char('8')`, nil, '8')
	expectRun(t, `out = char([1,8.1,true,3])`, nil, vm.UndefinedValue)
	expectRun(t, `out = char({a: 1, b: "foo"})`, nil, vm.UndefinedValue)
	expectRun(t, `out = char(undefined)`, nil, vm.UndefinedValue)
	...
	expectRun(t, `out = char(undefined, undefined)`, nil, vm.UndefinedValue)
	...
	expectRun(t, `out = bytes(1.8)`, nil, vm.UndefinedValue)
	expectRun(t, `out = bytes("-522")`, nil, []byte{'-', '5', '2', '2'})
	expectRun(t, `out = bytes(true)`, nil, vm.UndefinedValue)
	expectRun(t, `out = bytes(false)`, nil, vm.UndefinedValue)
	expectRun(t, `out = bytes('8')`, nil, vm.UndefinedValue)
	expectRun(t, `out = bytes([1])`, nil, vm.UndefinedValue)
	expectRun(t, `out = bytes({a: 1})`, nil, vm.UndefinedValue)
	expectRun(t, `out = bytes(undefined)`, nil, vm.UndefinedValue)
	...
	expectRun(t, `out = bytes(undefined, undefined)`, nil, vm.UndefinedValue)
	...
	expectError(t, `delete(1)`, nil, vm.ErrWrongNumArguments.Error())
	expectError(t, `delete(1, 2, 3)`, nil, vm.ErrWrongNumArguments.Error())
	expectError(t, `delete({}, "", 3)`, nil, vm.ErrWrongNumArguments.Error())
	...
	// splice
	expectError(t, `splice()`, nil, vm.ErrWrongNumArguments.Error())
...
func TestBytes(t *testing.T) {
	...
	expectRun(t, `out = bytes("abcde")[10]`, nil, vm.UndefinedValue)
}
...
func TestVMErrorUnwrap(t *testing.T) {
	...
	userFunc := func(err error) *vm.BuiltinFunction {
		return &vm.BuiltinFunction{Name: "user_func", Value: func(ctx context.Context, args ...vm.Object) (vm.Object, error) {
			return nil, err
		}}
	}
	userModule := func(err error) *vm.BuiltinModule {
		return &vm.BuiltinModule{
			Attrs: map[string]vm.Object{
				"afunction": &vm.BuiltinFunction{
					Name: "afunction",
					Value: func(ctx context.Context, a ...vm.Object) (vm.Object, error) {
						return nil, err
					},
				},
			},
...
func TestIf(t *testing.T) {
	...
	expectRun(t, `if (false) { out = 10 }`, nil, vm.UndefinedValue)
	...
	expectRun(t, `if (1 > 2) { out = 10 }`, nil, vm.UndefinedValue)
...
func (o *StringDict) IndexGet(index vm.Object) (vm.Object, error) {
	strIdx, ok := index.(*vm.String)
	if !ok {
		return nil, vm.ErrInvalidIndexType
	}
...
func (o *StringDict) IndexSet(index, value vm.Object) error {
	strIdx, ok := index.(*vm.String)
	if !ok {
		return vm.ErrInvalidIndexType
	}

	strVal, ok := vm.ToString(value)
	if !ok {
		return vm.ErrInvalidIndexValueType
	}
...
func (o *StringCircle) IndexGet(index vm.Object) (vm.Object, error) {
	intIdx, ok := index.(*vm.Int)
	if !ok {
		return nil, vm.ErrInvalidIndexType
	}
	...
	return &vm.String{Value: o.Value[r]}, nil
}

func (o *StringCircle) IndexSet(index, value vm.Object) error {
	intIdx, ok := index.(*vm.Int)
	if !ok {
		return vm.ErrInvalidIndexType
	}
...
func (o *StringArray) BinaryOp(
	...
	return nil, vm.ErrInvalidOperator
}
...
func (o *StringArray) Equals(x vm.Object) bool {
...
func (o *StringArray) Copy() vm.Object {
	return &StringArray{
...
func (o *StringArray) IndexGet(index vm.Object) (vm.Object, error) {
	intIdx, ok := index.(*vm.Int)
	if ok {
		if intIdx.Value >= 0 && intIdx.Value < int64(len(o.Value)) {
			return &vm.String{Value: o.Value[intIdx.Value]}, nil
		}

		return nil, vm.ErrIndexOutOfBounds
	}
	...
	if ok {
		for vidx, str := range o.Value {
			if strIdx.Value == str {
				return &vm.Int{Value: int64(vidx)}, nil
			}
		}
...
func (o *StringArray) IndexSet(index, value vm.Object) error {
	strVal, ok := vm.ToString(value)
	if !ok {
		return vm.ErrInvalidIndexValueType
	}
...
func (o *StringArray) Call(
	...
	for i, v := range o.Value {
		if v == s1 {
			return &vm.Int{Value: int64(i)}, nil
		}
	}
...
func TestIndexable(t *testing.T) {
	...
	expectRun(t, `out = dict["x"]`,
		Opts().Symbol("dict", dict()).Skip2ndPass(), vm.UndefinedValue)
	...
	expectRun(t, `out = arr["four"]`,
		Opts().Symbol("arr", strArr()).Skip2ndPass(), vm.UndefinedValue)
...
func (i *StringArrayIterator) Key() vm.Object {
	return &vm.Int{Value: int64(i.idx - 1)}
}

func (i *StringArrayIterator) Value() vm.Object {
	return &vm.String{Value: i.strArr.Value[i.idx-1]}
}

func (o *StringArray) Iterate() vm.Iterator {
...
out = {
	...
	expectRun(t, `out = {foo: 5}["bar"]`, nil, vm.UndefinedValue)
	expectRun(t, `key := "foo"; out = {foo: 5}[key]`, nil, 5)
	expectRun(t, `out = {}["foo"]`, nil, vm.UndefinedValue)
		...
		&vm.BuiltinModule{
			Attrs: map[string]vm.Object{
				"abs": &vm.BuiltinFunction{
					Name: "abs",
					Value: func(ctx context.Context, a ...vm.Object) (vm.Object, error) {
						v, _ := vm.ToFloat64(a[0])
						return &vm.Float{Value: math.Abs(v)}, nil
					},
				},
			},
		})
...
`), "Runtime Error: not callable: int\n\tat mod1:3:4\n\tat test:4:1")
	...
	expectRun(t, `out = import("mod0")`,
		Opts().Module("mod0", ``), vm.UndefinedValue)
	expectRun(t, `out = import("mod0")`,
		...
		&vm.BuiltinModule{
			Attrs: map[string]vm.Object{
				"intn": &vm.BuiltinFunction{
					...
					Value: func(ctx context.Context, a ...vm.Object) (vm.Object, error) {
						v, _ := vm.ToInt64(a[0])
						return &vm.Int{Value: rand.Int63n(v)}, nil
					},
				},
			},
		})
...
func testAllocsLimit(t *testing.T, src string, limit int64) {
	expectRun(t, src,
		Opts().Skip2ndPass(), vm.UndefinedValue) // no limit
	expectRun(t, src,
		Opts().MaxAllocs(limit).Skip2ndPass(), vm.UndefinedValue)
	expectRun(t, src,
		Opts().MaxAllocs(limit+1).Skip2ndPass(), vm.UndefinedValue)
	if limit > 1 {
		expectError(t, src,
...
func testEnumModule(t *testing.T, input string, expected interface{}) {
	expectRun(t, `enum := import("enum"); `+input, Opts().Module("enum", rumo.SourceModules["enum"].Module()), expected)
}
...
func traceCompileRun(file *parser.File, symbols map[string]vm.Object, modules *vm.ModuleMap, maxAllocs int64) (res map[string]vm.Object, trace []string, err error) {
	...
	tr := &vmTracer{}
	c := vm.NewCompiler(file.InputFile, symTable, nil, modules, tr)
	err = c.Compile(file)
	trace = append(trace,
		fmt.Sprintf("\n[Compiler Trace]\n\n%s",
			strings.Join(tr.Out, "")))
...
func formatGlobals(globals []vm.Object) (formatted []string) {
...
func errorObject(v interface{}) *vm.Error {
	return &vm.Error{Value: toObject(v)}
}

func toObject(v interface{}) vm.Object {
	switch v := v.(type) {
	case vm.Object:
		return v
	case string:
...
func objectZeroCopy(o vm.Object) vm.Object {
	switch o.(type) {
	case *vm.Int:
		return &vm.Int{}
	case *vm.Float:
